export type Product = {
  ...
  sizes: string[];
  description: string[];
  /** 캠페인 스토리가 있는 상품 — 상세 페이지에 /campaign 배너 노출 */
  campaignStory?: boolean;
};

export const products: Product[] = [
  {
    id: "braille-patch-tee-black",
  ...
  {
    id: "honey-glow-windbreaker-black",
  ...
  {
    id: "honey-glow-windbreaker-grey",
  ...
  {
    id: "punch-logo-half-zip-charcoal",
  ...
  },
  {
    ...
    sizes: ["S", "M", "L"],
    description: [
      "전판 그래피티 프린트의 오버핏 반팔 톱",
      "두께감 있는 코튼 저지 소재",
    ],
  },
  {
    id: "honey-graffiti-top-grey",
